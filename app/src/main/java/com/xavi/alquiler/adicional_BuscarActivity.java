...
public class adicional_BuscarActivity extends AppCompatActivity implements ProductoAdapterClik {
    ...
    public void onClick(int id, View view) {
        Intent intent = new Intent(adicional_BuscarActivity.this, Datos_basicosActivity.class);
        try {
    ...
    public class get_propiedades extends AsyncTask<Void, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progreso = new ProgressDialog(adicional_BuscarActivity.this);
        ...
        protected void onPostExecute(final String success) {
            ...
            if (!success.isEmpty()) {
                try {
                    ...
                    Adapter_propiedad adaptador = new Adapter_propiedad(adicional_BuscarActivity.this, arr, obj, adicional_BuscarActivity.this);
